...
const HeroSection = memo(function HeroSection() {
  return (
    <section className="h-screen w-full bg-[url('/images/gallery5.jpg')] bg-cover bg-center flex flex-col items-center justify-center relative">
...
const CurrentOffersSection = memo(function CurrentOffersSection() {
  ...
  return (
    <section id="current-offers" className="w-full bg-[url('/images/gallery6.jpg')] bg-cover bg-fixed py-16 relative">
...
const LoyaltyProgramSection = memo(function LoyaltyProgramSection() {
  return (
    <section className="w-full bg-[url('/images/event3.jpg')] bg-cover bg-center py-16 relative">
...
const NewsletterSection = memo(function NewsletterSection() {
  return (
    <section className="w-full bg-[url('/images/hero.jpg')] bg-cover bg-center py-16 relative">
