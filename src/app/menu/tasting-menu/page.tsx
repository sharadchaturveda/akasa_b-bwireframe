...
import { tastingMenu } from "@/data/tastingMenu";
import TastingMenuCategorySection from "@/components/menu/TastingMenuCategorySection";
...
export default function TastingMenuPage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      {/* Hero Section */}
      <section className="w-full bg-[url('/images/menu/tasting-menu/hero/hero.jpg')] bg-cover bg-center py-64 relative">
        <div className="absolute inset-0 bg-black/70"></div>
        <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
          <h1 className="text-4xl md:text-6xl font-playfair mb-6 text-white">Tasting Menu</h1>
          ...
          <p className="text-lg md:text-xl font-montserrat text-white/80 max-w-3xl mx-auto">
            A curated multi-course journey through Indian cuisine
          </p>
        </div>
      </section>
      ...
      <section className="w-full bg-black py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          ...
          {/* Menu Categories */}
          {tastingMenu.categories.map((category, index) => (
            <TastingMenuCategorySection key={index} category={category} />
          ))}
