...
const MobileEventsHeroSectionFixed = memo(function MobileEventsHeroSectionFixed() {
  ...
  return (
    <section className="w-full relative overflow-hidden events-hero-mobile">
      ...
      <div className="relative w-full h-[70vh]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
          ...
          <div className="mt-24">
            ...
            <h1 className="text-2xl font-playfair mb-5 text-white" style={{ textShadow: '0 2px 4px rgba(0,0,0,0.3)' }}>
              Events at Akasa
            </h1>

            {/* Gold bar positioned below the heading with increased margin */}
            <div className="w-16 h-[1px] bg-gradient-to-r from-[#E6C78B]/80 to-transparent mx-auto mb-6 gold-bar"></div>
