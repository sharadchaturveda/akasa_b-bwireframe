...
const HeroSection = memo(function HeroSection() {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="text-center relative z-20 mt-16 md:mt-24 animate-fadeIn">
        <div className="mb-10">
          <div className="flex flex-col items-center">
            <span className="text-sm md:text-base text-white/90 font-montserrat tracking-[0.3em] uppercase mb-2 animate-fadeSlideUp" style={{ animationDelay: '0.3s' }}>{"Experience"}</span>
            <h1 className="relative font-playfair text-4xl sm:text-5xl md:text-6xl text-white italic mb-2 animate-fadeSlideUp" style={{ animationDelay: '0.5s', textShadow: '0 4px 6px rgba(0, 0, 0, 0.3)' }}>
              {"Exquisite Indian Cuisine"}
            </h1>
            <div className="flex items-center justify-center w-full mb-4 animate-fadeSlideUp" style={{ animationDelay: '0.7s' }}>
              <div className="h-[1px] w-12 md:w-20 bg-gradient-to-r from-transparent via-white/60 to-transparent"></div>
              <div className="mx-4">
            ...
            <span className="text-xs md:text-sm text-white/80 font-montserrat tracking-wider animate-fadeSlideUp" style={{ animationDelay: '0.9s', letterSpacing: '0.1em' }}>{"Fine Dining at the Heart of Singapore"}</span>
          </div>
        </div>
        <div className="animate-fadeSlideUp" style={{ animationDelay: '1.1s' }}>
          <Link href="/menu">
            <Button variant="default" className="uppercase bg-[#1A2A3A] text-white hover:bg-[#0A1A2A] w-[240px] text-center shadow-lg">{"Explore Menu"}</Button>
          </Link>
        </div>
      </div>
