...
/**
 * LeftImagePanel Component
 *
 * The left side of the WhatsHappeningSection with an animated background image
 */
const LeftImagePanel = memo(function LeftImagePanel({ isVisible }: { isVisible: boolean }) {
  return (
...
/**
 * RightContentPanel Component
 *
 * The right side of the WhatsHappeningSection with content and background
 */
const RightContentPanel = memo(function RightContentPanel() {
  return (
 ...
 *
 * The content of the WhatsHappeningSection
 */
