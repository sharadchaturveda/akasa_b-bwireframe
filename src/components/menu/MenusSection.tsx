...
const MenusSection = memo(function MenusSection() {
  ...
  return (
    <section className="w-full bg-[url('/images/menu/gallery2.jpg')] bg-cover bg-center py-16 pb-0 relative">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="text-center">
          <Link href="/reservations">
            <Button className="bg-[#1A2A3A] text-white hover:bg-[#0A1A2A] w-[240px]" showArrow>
              {"Make a Reservation"}
            </Button>
          </Link>
        </div>
