...
const FlavorExperienceSection = memo(function FlavorExperienceSection() {
  return (
    <section className="w-full">
      ...
      <div className="relative p-4 md:py-6 md:px-8 flex flex-col justify-center" style={{ backgroundImage: "url('/images/home/philosophy-bg.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div className="relative max-w-md">
          ...
          <Link href="/reservations">
            <Button className="bg-[#E6C78B] text-black hover:bg-[#D4B679] w-[180px] text-sm">
              {"Reserve a Table"}
            </Button>
          </Link>
        </div>
