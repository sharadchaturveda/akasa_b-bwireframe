...
interface SetLunchFixedItemCardProps {
  item: FixedMenuItem;
}

const SetLunchFixedItemCard = memo(function SetLunchFixedItemCard({ item }: SetLunchFixedItemCardProps) {
  return (
...
export default SetLunchFixedItemCard;
