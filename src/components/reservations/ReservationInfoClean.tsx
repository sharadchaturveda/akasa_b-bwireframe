          ...
          <div className="dining-info-content">
            ...
            <div className="dining-info-content-inner">
              <div className="dining-info-label-value">
                <span className="dining-info-label">Lunch:</span>
                <span className="dining-info-text">Monday - Friday: 11:30 AM - 2:30 PM</span>
              </div>
              <div className="dining-info-label-value">
                <span className="dining-info-label">Dinner:</span>
                <span className="dining-info-text">Monday - Sunday: 5:30 PM - 10:30 PM</span>
              </div>
              <div className="dining-info-label-value">
                <span className="dining-info-label">Brunch:</span>
                <span className="dining-info-text">Saturday - Sunday: 10:00 AM - 2:30 PM</span>
              </div>
            </div>
          </div>
        </div>
