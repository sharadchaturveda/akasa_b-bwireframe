  ...
  useEffect(() => {
    ...
    const applyStyles = () => {
      ...
      const contentContainers =
        componentRef.current.querySelectorAll(".content-container");
      ...
      const iconContainers =
        componentRef.current.querySelectorAll(".icon-container");
  ...
  return (
    <div
      ref={(el) => {
        ...
        if (
          optimizationDisabledRef &&
          typeof optimizationDisabledRef === "object"
        ) {
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          >
            <div
              className="icon-container flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#1A2A3A] flex items-center justify-center"
              style={{ flexShrink: 0 }}
            >
              <svg
                className="w-5 h-5 sm:w-6 sm:h-6 text-[#E6C78B]"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            <div
              className="content-container flex-grow"
              style={{ flexGrow: 1, minWidth: 0 }}
            >
              <h3 className="text-lg sm:text-xl font-playfair text-white mb-2 sm:mb-4">
                Hours of Operation
              </h3>
            ...
            >
              ...
              <div className="space-y-2 text-white/80">
                ...
                <div className="flex flex-col sm:flex-row items-start mt-2">
                  <span
                    className="label-span sm:w-36 font-medium shrink-0 mb-1 sm:mb-0"
                    style={{ flexShrink: 0 }}
                  >
                    Parking:
                  </span>
            ...
            >
              ...
              <div className="space-y-3 text-white/80">
                <div className="flex items-start">
                  <span className="text-[#E6C78B] mr-2 sm:mr-3 flex-shrink-0">
                    •
                  </span>
                ...
                <div className="flex items-start">
                  ...
                  <span className="text-sm sm:text-base">
                    For private dining or large parties, please contact us
                    directly.
                  </span>
                </div>
              </div>
            ...
            >
              ...
              <div className="space-y-2 text-white/80">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center">
                  ...
                  <span className="text-[#E6C78B] break-all">
                    reservations@akasa.com
                  </span>
                </div>
                <p className="mt-2">
