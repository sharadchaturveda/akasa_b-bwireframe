...
const ReservationInfo = memo(function ReservationInfo() {
  return (
    <div className="bg-black/40 backdrop-blur-sm p-6 sm:p-8 md:p-12 border border-white/10 rounded-lg shadow-xl relative overflow-hidden">
      {/* Background pattern */}
      <div
      ...
      <div className="relative z-10">
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col md:flex-row gap-4 sm:gap-6 items-start">
            <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#1A2A3A] flex items-center justify-center">
            ...
            <div>
              ...
              <div className="space-y-2 text-white/80">
                <div className="flex flex-col sm:flex-row sm:items-center">
                  <span className="sm:w-36 font-medium mb-1 sm:mb-0">Monday - Saturday:</span>
                  <span className="text-[#E6C78B]">11:30 AM - 10:00 PM</span>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center">
                  <span className="sm:w-36 font-medium mb-1 sm:mb-0">Sunday:</span>
            ...
            <div>
              ...
              <div className="space-y-2 text-white/80">
                ...
                <div className="flex flex-col sm:flex-row items-start mt-2">
                  <span className="sm:w-36 font-medium shrink-0 mb-1 sm:mb-0">Parking:</span>
          ...
          <div className="flex flex-col md:flex-row gap-4 sm:gap-6 items-start">
            ...
            <div>
              ...
              <div className="space-y-2 text-white/80">
                <div className="flex flex-col sm:flex-row sm:items-center">
                  <span className="sm:w-36 font-medium mb-1 sm:mb-0">Phone:</span>
                  <span className="text-[#E6C78B]">+65 6123 4567</span>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-center">
                  <span className="sm:w-36 font-medium mb-1 sm:mb-0">Email:</span>
